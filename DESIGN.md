...
```
 ...
 Marquee 사각형       | 1px dashed #8b5cf6 + bg rgba(0.08)
...
## Interaction States — Multi-Select & Rubber Band
...
```
 ...
 Marquee 시작           | 보라 점선 1px 사각형 + 0.08 배경
 Marquee 확장           | 사각형 크기 변화
 Marquee 릴리즈         | 영역 내 요소에 보라 실선 하이라이트
...
| 2026-03-21 | Marquee: 보라 점선 + crosshair | 선택 계열 색상 일관성 + Figma/Photoshop 표준 커서 |
